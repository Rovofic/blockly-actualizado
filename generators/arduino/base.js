...
goog.module('Blockly.Arduino.base');
...
Blockly.Arduino.base_delay_init = function() {
  var code = 'delay(1000);\n';
  return code;
};

Blockly.Arduino.base_delay_fin = function() {
  var code = 'delay(1200000);\n';
  return code;
};
...
Blockly.Arduino.serial_printlnn = function() {
  var content = Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC) || '0'
...
Blockly.Arduino['serial_readd'] = function() {
  Blockly.Arduino.setups_['setup_serial_' + profile.default.serial] = 'Serial.begin(' + profile.default.serial + ');\n';
...
Blockly.Arduino.serial1_print = function() {
  var content = Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC) || '0'
  //content = content.replace('(','').replace(')','');

  Blockly.Arduino.setups_['setup_serial1_' + profile.default.serial1] = 'Serial1.begin(' + profile.default.serial + ');\n';

  var code = 'Serial1.print(' + content + ');\n';
  return code;
};

Blockly.Arduino.serial1_printlnn = function() {
  var content = Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC) || '0'
  //content = content.replace('(','').replace(')','');
...
Blockly.Arduino['serial1_readd'] = function() {
...
Blockly.Arduino['aarduino_setup'] = function() {
